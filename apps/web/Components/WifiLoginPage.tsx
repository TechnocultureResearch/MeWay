...
return(
    <div className=" flex flex-col items-center text-white h-screen bg-black">
        ...
        <div className="text-5xl text-left font-normal leading-none non-italic decoration-1 mt-12">
          <p className="text-5xl text-left font-normal leading-none non-italic decoration-1">Hello!</p> 
          <p>from <strong className="font-bold">meway</strong></p>
        </div> 
        ...
        <div className="pt-14 "> 
            ...
            <select className="w-20 h-10 text-white bg-[#212121] border rounded-md mx-2 mr-11">
                ...
                <button className="bg-[#212121] border text-white font-inter w-10 h-10 rounded mx-3">F</button>
                <button className="bg-[#212121] border text-white font-inter w-10 h-10 rounded mx-3">M</button>
                </div>
                <div className="mt-5">
        ...
        <div className="font-serif text-center font-light text-base non-italic leading-5 
