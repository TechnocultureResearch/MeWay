...
const File = () => {
  function ensureFolderExists () {
    ...
    return getInfoAsync(path).then(info => {
      if (!info.exists) {
        return makeDirectoryAsync(path
        ).then((uri) => {
